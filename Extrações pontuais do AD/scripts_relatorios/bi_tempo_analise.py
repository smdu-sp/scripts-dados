...
class TableExtract(FullAd):
    ...
    def tabela(self):
        ...
        attributes = ['id', 'n_processo', 'protocolo', 'assunto', 'data_autuacao', 'despacho', 'data_despacho']
        ...
        data_container['despacho'] = self.find_value('action', despachos[-1])
        data_container['data_despacho'] = self.find_value('date', despachos[-1])
    ...
    def table_creator(self):
        ...
        file_path = f'{dir_raw_data}/bi_tempo_analise.csv'
