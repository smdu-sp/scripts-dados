...
class TableExtract(FullAd):
    ...
    def tabela(self):
        ...
        attributes = ['n_processo', 'assunto', 'status', 'data_deferimento', 'tipo_de_localizacao', 'localizacao',
                      'endereco', 'cep', 'distrito', 'subprefeitura', 'categoria_uso', 'numero_documento',
                      'certf_conclusao_tipo', 'area_objeto_certf_concl']
    ...
    def table_creator(self):
        ...
        file_path = f'{dir_raw_data}/ad_certificado_conclusao_completo.csv'
