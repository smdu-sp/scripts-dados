...
class TableExtract(FullAd):
    ...
    def tabela(self):
        ...
        attributes = ['id', 'protocolo', 'processo', 'assunto', 'data_extracao',
                      'despacho', 'data_despacho', 'coord_despacho', 'quem_despachou', 'documento']
        ...
        for i in despachos:
            ...
            data_container['documento'] = self.get_ad() if data_container['despacho'] == 'Processo Deferido' else None
    ...
    def table_creator(self):
        ...
        file_path = f'{dir_raw_data}/ad_timeline_despachos.csv'
