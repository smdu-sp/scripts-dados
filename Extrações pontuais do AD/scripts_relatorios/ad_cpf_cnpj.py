...
class TableExtract(FullAd):
    ...
    def tabela(self):
        ...
        attributes = ['id', 'protocolo', 'n_processo', 'data_autuacao', 'assunto', 'proc_status', 'data_extracao',
                      'cpf_cnpj', 'tipo']
        ...
        for i in cnpjs:
            data_container['cpf_cnpj'] = self.get_status()
            data_container['tipo'] = self.get_status()
