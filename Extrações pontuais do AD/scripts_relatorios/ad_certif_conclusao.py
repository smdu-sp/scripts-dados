...
class TableExtract(FullAd):
    ...
    def tabela(self):
        ...
        attributes = ['id', 'protocolo', 'n_processo', 'assunto', 'processo_vinculado']
        ...
        data_container['processo_vinculado'] = self.get_proc_vinculado()
    ...
    def table_creator(self):
        ...
        file_path = f'{dir_raw_data}/ad_certif_conc_vinculado.csv'
