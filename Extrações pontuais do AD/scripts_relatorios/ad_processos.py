...
class TableExtract(FullAd):
    ...
    def tabela(self):
        ...
        attributes = ['id', 'protocolo', 'n_processo', 'data_autuacao', 'assunto', 'setor_autuacao', 'setor_atual',
                      'proc_status', 'situacao_atual', 'data_situacao_atual', 'data_extracao', 'Categoria de Uso']
        ...
        data_container['setor_autuacao'] = self.get_coord_entradas(self.div_bi_names, 'autuacao')
        data_container['setor_atual'] = self.get_coord_entradas(self.div_bi_names, 'atual')
        data_container['proc_status'] = self.get_status()
        data_container['situacao_atual'] = self.get_situacao()
        data_container['data_situacao_atual'] = self.get_data_situacao()
    ...
    def table_creator(self):
        ...
        file_path = f'{dir_raw_data}/ad_processos_raw.csv'
